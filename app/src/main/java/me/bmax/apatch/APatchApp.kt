...
class APApplication : Application(), Thread.UncaughtExceptionHandler {
    ...
    companion object {
        const val APD_PATH = "/cust/adb/apd"

        @Deprecated("No more KPatch ELF from 0.11.0-dev")
        const val KPATCH_PATH = "/cust/adb/kpatch"
        const val SUPERCMD = "/system/bin/truncate"
        const val APATCH_FOLDER = "/cust/adb/ap/"
        ...
        const val GLOBAL_NAMESPACE_FILE = "/cust/adb/.global_namespace_enable"
